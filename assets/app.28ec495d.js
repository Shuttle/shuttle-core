...
const _sfc_main$w = /* @__PURE__ */ defineComponent({
  setup(__props) {
    const { theme } = useData();
    const VPAlgoliaSearchBox = defineAsyncComponent(() => import("./chunks/VPAlgoliaSearchBox.f8e70f5d.js"));
    const loaded = ref(false);
    const metaKey = ref();
    onMounted(() => {
...
export { Fragment as F, VTIconShuttle as V, _export_sfc as _, createStaticVNode as a, createBaseVNode as b, createElementBlock as c, createApp, createVNode as d, VTIconDiscord as e, popScopeId as f, createTextVNode as g, defineComponent as h, useData as i, useRoute as j, useRouter as k, onMounted as l, openBlock as o, pushScopeId as p, unref as u };
