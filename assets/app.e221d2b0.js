...
const _sfc_main$w = /* @__PURE__ */ defineComponent({
  setup(__props) {
    const { theme } = useData();
    const VPAlgoliaSearchBox = defineAsyncComponent(() => import("./chunks/VPAlgoliaSearchBox.67ec0f86.js"));
    const loaded = ref(false);
    const metaKey = ref();
    onMounted(() => {
