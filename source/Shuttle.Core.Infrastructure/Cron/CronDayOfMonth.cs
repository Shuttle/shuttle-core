...
{
	internal class CronDayOfMonth : CronField
	{
		private readonly Regex WeekdayExpression = new Regex(@"^(?<day>\d+)W$", RegexOptions.IgnoreCase);
			...
			: base(value)
		{
			...
			var match = WeekdayExpression.Match(value);
