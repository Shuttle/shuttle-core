...
namespace Shuttle.Core.Infrastructure
{
	public class CronExpression
	{
		...
		private void ParseExpression(string expression)
		{
			...
			Guard.Against<CronException>(length != 5, string.Format(InfrastructureResources.CronInvalidFieldCount, length));
			...
			Guard.Against<CronException>(cronDayOfMonth.ExpressionType == ExpressionType.Skipped
			                             ...
			                             string.Format(InfrastructureResources.CronNoDaysSpecified, expression));
			Guard.Against<CronException>(cronDayOfMonth.ExpressionType != ExpressionType.Skipped
			                             &&
			                             ...
			                             string.Format(InfrastructureResources.CronBothDaysSpecified, expression));
		}
