...
<template>
  ...
  <section id="highlights" class="vt-box-container">
    <div class="vt-box">
      ...
      <div>Packages currently target <code>netstandard2.0</code> and <code>netstandard2.1</code> which means that they can be used with .NET Core 2.1+, .NET Framework 4.6.1+, and .NET 5.0+</div>
    </div>
    <div class="vt-box">
